...
def get_sensor_data():
    ...
    cnx, cursor = createConnection(
            'sql10652855', 'sql10652855', 'qN8cu9iQtI', 'sql10.freemysqlhosting.net', '3306')
...
def receive_sensor_data():
    if request.headers['Content-Type'] == 'application/json':
        ...
        print("Recibí datos correctamente.")

        cnx, cursor = createConnection(
            'sql10652855', 'sql10652855', 'qN8cu9iQtI', 'sql10.freemysqlhosting.net', '3306')

        add_data = (
            "INSERT INTO dht_sensor_data (humidity, temperature, smoke, date_time) VALUES (%s, %s, %s, %s)")
